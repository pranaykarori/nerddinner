		...
		-- --------------------------------------------------
		-- Date Created: 06/23/2012 18:43:14
		-- Generated from EDMX file: C:\Users\jeremiah\Projects\NerdDinner_2.0\NerdDinner\Models\NerdDinner.edmx
		-- --------------------------------------------------
		...
		IF OBJECT_ID(N'[dbo].[FK_RSVP_Dinners]', 'F') IS NOT NULL
			ALTER TABLE [dbo].[RSVPs] DROP CONSTRAINT [FK_RSVP_Dinners];
		GO
